...
// #define CONFIGURE_ARGS " '--with-bonjour' '--without-icu' '--with-lz4' '--without-readline' '--with-zlib' '--without-zstd' '--with-openssl' '--without-libxml' '--without-libxslt' '--disable-nls' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/Users/darnyelx/Projects/CSCN71030_Group3/vcpkg_installed/arm64-osx' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc -DNDEBUG -fPIC -O3' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/Users/darnyelx/Projects/CSCN71030_Group3/vcpkg_installed/arm64-osx/lib -headerpad_max_install_names' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/opt/homebrew/bin/pkg-config' 'PKG_CONFIG_PATH=/Users/darnyelx/vcpkg/packages/libpq_arm64-osx/lib/pkgconfig:/Users/darnyelx/vcpkg/packages/libpq_arm64-osx/share/pkgconfig:/Users/darnyelx/Projects/CSCN71030_Group3/vcpkg_installed/arm64-osx/lib/pkgconfig:/Users/darnyelx/Projects/CSCN71030_Group3/vcpkg_installed/arm64-osx/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 18.3 on aarch64-apple-darwin25.0.0, compiled by Apple clang version 17.0.0 (clang-1700.3.19.1), 64-bit"
